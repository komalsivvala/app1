...
| Home | Exam | Result | Review |
|---|---|---|---|
| ![](docs/screenshots/home-light.png) | ![](docs/screenshots/exam-session-light.png) | ![](docs/screenshots/exam-result-dark.png) | ![](docs/screenshots/exam-review-light.png) |

Every screen × {light, dark} is in `docs/screenshots/` — 20 images, regenerated by CI on every push.
