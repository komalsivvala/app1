...
| Home | Pre-exam (config-driven) | Settings | About |
|---|---|---|---|
| ![](docs/screenshots/home-light.png) | ![](docs/screenshots/exam-intro-light.png) | ![](docs/screenshots/settings-dark.png) | ![](docs/screenshots/about-light.png) |

Every screen × {light, dark} is in `docs/screenshots/` — 14 images, regenerated by CI on every push.
...
src/engine/                  exam-config.ts (typed view); examEngine/selection arrive at M3
